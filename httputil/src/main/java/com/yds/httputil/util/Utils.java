...
//            SoftLightManager.get().initSoftLightView(activity);
//            SoftLightManager.get().toggleSlMode(activity, getSpValue(KEY_SOFT_LIGHT, false));
        }
...
//            SoftLightManager.get().clearRecord(activity);
        }
